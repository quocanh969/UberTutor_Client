...
export default function Profile() {
    ...
    const newPassword = <TextField
        ...
        margin="normal"
    />
    const confirmNewPassword = <TextField
        id="standard-password-input"
