...
class Register extends Component {
    ...
    componentWillMount() {
        let { onStudentRegisterRefresh } = this.props;
    ...
    handleSubmit(e) {
        ...
        if (this.user.password === this.refs.confirm.value) {
            let { onStudentRegister } = this.props;
            onStudentRegister(this.user);
        }
        else {
            let { onStudentValidateFail } = this.props;
            onStudentValidateFail('Repeat is not the same as password');
        }
    }
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-7">
                                    <div className="p-5">
                                        ...
                                        <div className="text-center">
                                            <NavLink className="small" to="/tutorRegister">Want to become a tutor?</NavLink>
                                        </div>
                                        <div className="text-center">
